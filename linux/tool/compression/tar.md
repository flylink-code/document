...
|tar -cjvf xxx.tar xxx|*.tar.bz2||

|命令|解压格式|备注|
|----|----|----|
|tar -xvf xxx.tar|*.tar||
|tar -xjvf xxx.tar xxx|*.tar.bz2||

### 2.2 常用操作
#### 2.2.1 压缩时排除指定文件
* tar -jcvf xxx.tar.bz2 xxx –exclude=”.git” –exclude=”out_x3399” –exclude=”*.o” –exclude=”*.cmd”
